...
class Conference(models.Model):
	...
	confer_apart = models.ForeignKey(Apartment, on_delete=models.ProtectedError, verbose_name='所属部门',null=True)
	...
	time = models.FloatField(max_length=10, verbose_name='持续时间',default=0.0)
...
class Topic(models.Model):
	...
	def __str__(self):
		return self.people_id, self.confer_id
